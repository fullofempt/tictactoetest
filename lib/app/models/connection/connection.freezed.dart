...
abstract class $ConnectionCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<String> history, String hostName, String id, String name});
}
...
class _$ConnectionImpl implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(history: $history, hostName: $hostName, id: $id, name: $name)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_history), hostName, id, name);
